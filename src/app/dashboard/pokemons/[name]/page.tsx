...
export async function generateMetada({ params }: Props): Promise<Metadata> {
  try {
    ...
    return {
      ...
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias beatae excepturi aliquid! Rerum ad quae molestiae, culpa repellat sapiente quibusdam quas blanditiis exercitationem nesciunt in ipsa eligendi. Quibusdam, error quidem.",
    };
  }
}
